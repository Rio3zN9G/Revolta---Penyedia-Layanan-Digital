...
function tampilkanHarga(kategori) {
    ...
    filteredData.forEach(item => {
        ...
        card.innerHTML = `
            ...
            <a href="https://wa.me/6285189119169?text=Halo,%20saya%20ingin%20memesan%20${encodeURIComponent(item.nama)}%20apa%20betul%20dimulai%20Rp${item.harga.toLocaleString()}" target="_blank" class="wa-button">
                WhatsApp
            </a>
        `;
